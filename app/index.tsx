      ...
      <BottomSheetModalProvider>
        <View className="h-full bg-primary py-16 flex items-center font-plain">
          ...
          <View className="h-full flex items-center justify-center gap-4">
            <Link
              href="/scan"
              className="text-white font-bold bg-black py-2 px-6 rounded-full text-3xl transition ease-in-out duration-300 font-plainBold active:bg-yellow-400 active:text-black"
            >
              Scan
            </Link>
            <Link
